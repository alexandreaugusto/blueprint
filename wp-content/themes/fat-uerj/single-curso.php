      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <ul class="breadcrumb"><?php $terms = get_the_terms( $post->ID, 'tipo_curso' );$categories = $terms;if(count($terms) > 1 && $terms[1]->slug == "pos-graduacao"){echo $terms[1]->slug . "la la la";$categories = array_reverse($terms);}var_dump($categories); ?>
              <li><a href="#">Home</a></li>
