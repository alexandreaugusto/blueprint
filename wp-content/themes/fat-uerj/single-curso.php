        ...
        <div class="col-md-9">
          <div class="row">
            ...
            <div class="professor col-md-4">
              ...
              <img src="<?php print_r(empty(get_the_author_meta('foto', $coordenador['ID'])))?get_template_directory_uri() . "/img/noone.jpg":wp_get_attachment_url(get_the_author_meta('foto', $coordenador['ID']))[0]; ?>">
