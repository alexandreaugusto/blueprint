...
<?php if (have_posts()) while (have_posts()) : the_post(); ?>
    ...
    <div class="container main internal">
      <div class="row">
        <div class="col-md-12">
          <h2 class="text-uppercase page-header">Contato</h2>
          <div class="row">
            <div class="col-md-7">
                <form class="form-horizontal">
                  <fieldset>
                    ...
                    <div class="form-group has-error">
                      ...
                      <div class="col-lg-10">
                        <input type="text" class="form-control" id="inputEmail" placeholder="Qual seu e-mail?">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-lg-10">
                        <input type="text" class="form-control" id="inputTel" placeholder="Deixe seu telefone conosco">
                      </div>
                    </div>
                    <div class="form-group">
