                    ...
                    <div class="col-md-12">
                        ...
                        <div class="well col-md-12">
                            ...
                            <div class="col-md-4">
                                ...
                                <img src="<?php echo (empty(get_the_author_meta('foto', $subchefe['ID'])))?get_template_directory_uri() . "/img/noone.jpg":wp_get_attachment_url(get_the_author_meta('foto', $subchefe['ID'])); ?>" width="96" height="96">
